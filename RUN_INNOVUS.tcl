# =============================================================================
# 1. SETUP & VARIABLES ( SCL MOHALI 180nm )
...
# =============================================================================
set design "mkSoc"
set PDK_PATH "/mnt/c2s/cadence/Analog_tools/FOUNDRY/scl_pdk/stdlib/fs120"

# Input Files
set netlist  "/home/student/Bhavyabansal/Verilog/final.v"
set sdc_file "/home/student/contraints.sdc"
set lef_file [list \
   $PDK_PATH/tech_data/lef/tsl180l4.lef \
   $PDK_PATH/lef/tsl18fs120_scl.lef \
]

set lib_file "$PDK_PATH/spc/liberty/lib_flow_ff/tsl18fs120_scl_ff.lib"
...
# =============================================================================
# 4. FLOORPLANNING ( 60:40 and 70:30)
# =============================================================================
#floorPlan -site CoreSite -r 0.7 0.7 10 10 10 10

# 60% Core Utilization (40% whitespace for routing)
floorPlan -site CoreSite -r 0.6 1.0 10 10 10 10
...
# Save Final
saveNetlist /home/student/Bhavyabansal/asic_top_pr.v -excludeLeafCell
setExtractRCMode -engine postRoute -effortLevel low
extractRC
rcOut -spef /home/student/Bhavyabansalasic_top.spef -rc_corner default_rc_corner
streamOut /home/student/Bhavyabansalfinal_layout.gds -units 1000 -mode ALL
saveDesign /home/student/Bhavyabansal/final_design_golden.enc
